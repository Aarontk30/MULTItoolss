...
def run():
    """ Fonction principale de l'outil Webhook Info. """
    ...
    try:
        def info_webhook(webhook_url):
            ...
            Slow(f"""
{white}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
 {INFO_ADD} ID         : {white}{webhook_id}{magenta}
 {INFO_ADD} Token      : {white}{webhook_token}{magenta}
 {INFO_ADD} Name       : {white}{webhook_name}{magenta}
 {INFO_ADD} Avatar     : {white}{webhook_avatar}{magenta}
 {INFO_ADD} Type       : {white}{webhook_type}{magenta}
 {INFO_ADD} Channel ID : {white}{channel_id}{magenta}
 {INFO_ADD} Server ID  : {white}{guild_id}{magenta}
{white}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
\"\"\")
            ...
            Slow(f"""{magenta}User information associated with the Webhook:
{white}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
 {INFO_ADD} ID          : {white}{user_id}{magenta}
 {INFO_ADD} Name        : {white}{username}{magenta}
 {INFO_ADD} DisplayName : {white}{display_name}{magenta}
 {INFO_ADD} Number      : {white}{discriminator}{magenta}
 {INFO_ADD} Avatar      : {white}{user_avatar}{magenta}
 {INFO_ADD} Flags       : {white}{user_flags} Publique: {user_flags}{magenta}
 {INFO_ADD} Color       : {white}{accent_color}{magenta}
 {INFO_ADD} Decoration  : {white}{avatar_decoration}{magenta}
 {INFO_ADD} Banner      : {white}{banner_color}{magenta}
{white}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
    \"\"\")
